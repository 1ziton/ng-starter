...
import { Component, EventEmitter, Input, NgModule, Output, QueryList, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, OnInit, OnDestroy, AfterViewInit } from '@angular/core';
...
export class UIGridComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @ViewChildren('dpd') dpd: QueryList<NzDropDownComponent>;
